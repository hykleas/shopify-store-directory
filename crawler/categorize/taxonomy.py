...
TAXONOMY: dict[str, dict[str, list[str]]] = {
    "Apparel": {
        "T-Shirts & Tops": ["Oversized Cotton Crewneck Tee", "Graphic Print T-Shirt Unisex", "Ribbed Crop Tank Top", "Vintage Washed Boxy Tee", "Long Sleeve Henley Shirt", "Muscle Fit V-Neck T-Shirt"],
        "Hoodies & Sweatshirts": ["Heavyweight Fleece Pullover Hoodie", "Embroidered Logo Crewneck Sweatshirt", "Zip-Up Hoodie with Kangaroo Pocket", "Oversized Drop Shoulder Sweatshirt", "Sherpa Lined Hooded Jacket", "Cropped Raw Hem Hoodie"],
    ...
    "Beauty & Cosmetics": {
        "Skincare": ["Vitamin C Brightening Serum", "Hyaluronic Acid Hydrating Moisturizer", "Retinol Night Cream Anti Aging", "Gentle Foaming Face Cleanser", "Niacinamide Pore Minimizing Toner", "Clay Detox Face Mask"],
    ...
    "Home & Kitchen": {
        ...
        "Tableware & Drinkware": ["Stoneware Dinner Plate Set", "Insulated Stainless Steel Tumbler", "Crystal Wine Glass Set of 4", "Bamboo Serving Tray", "Ceramic Mug Handmade Speckled", "Glass Water Carafe with Lid"],
    ...
    "Furniture & Decor": {
        ...
        "Wall Art & Prints": ["Abstract Canvas Wall Art Set", "Botanical Line Drawing Print", "Vintage Movie Poster Framed", "Macrame Wall Hanging Boho", "Metal Wall Sculpture Modern", "Personalized Family Name Sign"],
    ...
    "Pet Supplies": {
        ...
        "Pet Health": ["Dog Dental Chews Breath", "Flea and Tick Collar", "Joint Supplement Chews Glucosamine", "Pet Calming Diffuser Spray", "Paw Balm Protective Wax", "Ear Cleaning Solution Pets"],
    ...
    "Baby & Kids": {
        ...
        "Feeding & Nursing": ["Anti Colic Baby Bottle Set", "Silicone Bib with Food Catcher", "Electric Breast Pump Double", "Bottle Warmer and Sterilizer", "Toddler Snack Cup Spill Proof", "Nursing Pillow Cover"],
        "Nursery & Sleep": ["Convertible Crib 4 in 1", "Baby Monitor Video WiFi", "Blackout Nursery Curtains", "Sleep Sack Wearable Blanket", "Changing Pad Waterproof Cover", "Nursery Storage Baskets Set"],
        ...
        "Bath & Diapering": ["Baby Bath Tub Foldable", "Diaper Caddy Organizer Portable", "Hooded Baby Towel Bamboo", "Wipe Warmer Dispenser", "Reusable Cloth Diapers Set", "Baby Shampoo Tear Free"],
        ...
        "Kids Room & Play": ["Play Tent Teepee Indoor", "Toy Storage Organizer Bins", "Kids Table and Chair Set", "Growth Chart Wooden Ruler", "Foam Play Mat Interlocking", "Kids Reading Nook Book Rack"],
    },
    "Toys & Games": {
    ...
    "Tools & DIY": {
        ...
        "Plumbing & Electrical": ["Pipe Wrench Heavy Duty", "Wire Stripper Crimper Tool", "Multimeter Digital Auto Ranging", "Drain Snake Auger Cordless", "Heat Shrink Tubing Kit", "Voltage Tester Non Contact"],
    },
    "Office & Stationery": {
    ...
    "Arts & Crafts": {
        ...
        "Paper Crafts": ["Die Cutting Machine Starter", "Cardstock Paper Pack Colored", "Scrapbook Album Refillable", "Washi Tape Set Decorative", "Origami Paper Double Sided", "Quilling Paper Strips Kit"],
